...
df = pd.read_csv('DINOUNETFINAL.txt')
...
labels = {'AG_fullV2_constant': 'UNetDinoAttGate', 'v1_constant': 'UNetDino', 'VanillaUNet_model': 'Vanilla UNet','DinoEnvALT_constant': 'DinoEnc (vits16)'}
...
plt.savefig('LargeTrainingDataFinalPerformance.png', bbox_inches='tight')
plt.savefig('LargeTrainingDataFinalPerformance.pdf', bbox_inches='tight')
